 ...
 * @return {?}
 */
var b = function (e, dt) { // returns element e from array a
  /** @type {number} */
  e = e - 0;
  var ret = a[e];
  return ret;
...
$(b("0x2"))["on"]("input", function () {
  var range = {
    ...
    "eHQca": "li:last-of-type",
    "GujvX": function (saveNotifs, notifications) {
      return saveNotifs(notifications);
    },
    "Ddhlq": function (p, eof) {
      return p == eof;
    },
    ...
    "uzDGk": function (name, requiredFrom) {
      return name == requiredFrom;
    },
    "vbeRI": function (_num1, _num2) {
      return _num1 > _num2;
    }
  };
          ...
          switch (callbackVals[callbackCount++]) {
            ...
            case "3":
              range[b("0x2c")](setTimeout, function () {
                window[b("0x2d")]["replace"](range[b("0x2e")]);
              }, 3E3);
              continue;
            case "4":
...
setInterval(function () {
  ...
  $(timeline_items[b("0x36")])[b("0x16")](timeline_items[b("0x37")]);
}, 400);